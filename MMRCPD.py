...
class MMRCPD():
    ...
    def __init__(self,
        ...
        self.horizon = int(np.log(threshold_h)/np.log(1-rho))+1
        ...
        # Last counts
        shape_last_SA = self.shape_SA+(self.horizon,)
        ...
        # Contains the recent model of transitions
        self.recent_tSAS = self.tSAS.copy()
        self.recent_R = self.R.copy()
